...
import { Button, Input, Tooltip, message, Drawer, List, Avatar } from 'antd';
import { useNavigate } from 'react-router-dom';
import styled, { keyframes } from 'styled-components';
import { MenuOutlined, PlusOutlined, PictureOutlined, SendOutlined, SettingOutlined, CopyOutlined, CheckOutlined, DeleteOutlined, DownOutlined, UpOutlined } from '@ant-design/icons';
